...
using AuthenticationLearning.Data;
using AuthenticationLearning.Models;
using Microsoft.AspNetCore.Authorization;

namespace AuthenticationLearning.Controllers
{
    [Authorize]
    public class LeadsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Mobile,Email,Source,IsBlocked")] SalesLeadEntity salesLeadEntity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Mobile,Email,Source,IsBlocked")] SalesLeadEntity salesLeadEntity)
        {
        ...
        public async Task<IActionResult> BlockConfirmed(int id)
        {
            ...
            if (salesLeadEntity != null)
            {
                salesLeadEntity.IsBlocked = true;
                _context.Update(salesLeadEntity);
                await _context.SaveChangesAsync();
            }
            return RedirectToAction(nameof(Index));
        ...
        public async Task<IActionResult> UnblockConfirmed(int id)
        {
            ...
            if (salesLeadEntity != null)
            {
                salesLeadEntity.IsBlocked = false;
                _context.Update(salesLeadEntity);
                await _context.SaveChangesAsync();
            }
            return RedirectToAction(nameof(Index));
